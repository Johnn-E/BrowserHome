				...
				<div class="col2">
					<div align="center">
						<div class="fire" style="padding-top:-100px; margin-left:-47px; width:159px; height:150px;">
							<img src="js-css/img/W0VdA4J.png" alt="Home" border="0" class="firefox" />
						</div>
						<br />
						<p>Ricerca</p>
					</div>
					...
					<div style=" margin-top:-13px; margin-bottom:3px;" class="content">
						<div>
							<form action="http://google.it/search" name="f">
								...
								<p align="center">
									<input type="text" name="q" size="38" maxlength="255" value="" id="sbi" style="font-family:Times;color:#FFFFFF;font-size:14pt;border: 1px solid #333333;background-color: #111; text-align:center; width:321px; margin-left:16px; margin-bottom:-8px;"></input><br />
									<input class="button-images" type="submit" name="sa" value="&nbsp;" id="sbb" style="font-size: 12pt; background-color:#333; font-family:Times; font-weight:bold; color:#FFF; border-radius: 0px; margin-left:16px; width:100px; margin-top:7px;border:1px solid #333333; "></input>
							</form>
								</p>
						</div>
					</div>
					...
					<div class="hi-icon-wrap hi-icon-effect" style="margin-left:+33px;" align="center">
						<table class="icon" border="0" width="400" align="center">
							...
							<tr>
								<td><a href="#"><img class="imma hi-icon" src="js-css/img/facebook.png" width="55" height="55" /></a></td>
								<td><a href="#"><img class="imma hi-icon" src="js-css/img/youtube.png" width="55" height="55" /></a></td>
								<td><a href="#"><img class="imma hi-icon" src="js-css/img/imgur.png" width="55" height="55" /></a></td>
							</tr>
							-->
						</table>
					</div>
